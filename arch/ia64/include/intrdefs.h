...
#ifndef _IA64_INTRDEFS_H
#define _IA64_INTRDEFS_H
...
#define ia64_IPI_HALT			0x00000001
#define ia64_IPI_NOP			0x00000002
#define ia64_IPI_FLUSH_FPU		0x00000004
#define ia64_IPI_SYNCH_FPU		0x00000008
#define ia64_IPI_TLB			0x00000010
#define ia64_IPI_MTRR			0x00000020
#define ia64_IPI_SETPERF			0x00000040
#define ia64_IPI_DDB			0x00000080

#define ia64_NIPI			8

#define ia64_IPI_NAMES { "halt IPI", "nop IPI", "FPU flush IPI", \
			 "FPU synch IPI", "TLB shootdown IPI", \
			 "MTRR update IPI", "setperf IPI", "ddb IPI" }

#define IREENT_MAGIC	0x18041969

#endif /* _IA64_INTRDEFS_H */
